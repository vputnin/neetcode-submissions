class Solution {
    public int shortestPathBinaryMatrix(int[][] grid) {
        ...
        //Felt too relaxed and had syntax errors with adding and removing elements from the deque, and didn't mark elements (I think because I listened to a podcast in the background).
